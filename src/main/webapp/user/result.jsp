...
<body>
	...
	<nav class="app-navbar">
		...
		<a href="${pageContext.request.contextPath}/user/userDashboard.jsp"
			...
			<div class="brand-icon">🎓</div> QuizPortal
			...
			<div class="result-body">
				...
				<div class="summary-box">
					...
					<div class="summary-item">
						...
						<div class="summary-value" style="color:<%=scoreColor%>;">
					...
					<div class="summary-item">
						...
						<div class="summary-value">
							...
							<span class="status-badge <%=badgeClass%>"> <%=badgeEmoji%>
								<%=badgeText%>
				...
				<div class="action-buttons">
					...
					<a href="${pageContext.request.contextPath}/user/startQuiz.jsp"
						class="btn-custom btn-primary-custom"> 🔄 Retry Quiz </a> <a
						href="${pageContext.request.contextPath}/user/userDashboard.jsp"
						class="btn-custom btn-outline-custom"> 🏠 Dashboard </a> <a
						href="${pageContext.request.contextPath}/user/reviewAnswers.jsp"
						class="btn-custom btn-outline-custom"> 📘 View Answers </a>
