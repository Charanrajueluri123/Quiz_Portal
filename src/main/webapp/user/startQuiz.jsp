...
<aside class="sidebar">
  ...
  <a href="userDashboard.jsp" class="sidebar-link">
    <i class="bi bi-grid-1x2"></i> Dashboard
  </a>
  <a href="startQuiz.jsp" class="sidebar-link active">
...
<main class="main-content">
  ...
  <div class="quiz-start-card">
    ...
    <div class="quiz-start-header">
      ...
      <p>Answer all questions carefully. Your score will be saved automatically.</p>
    </div>
    ...
    <div class="quiz-start-body">
      ...
      <div class="info-row">
        ...
        <span>All available questions included</span>
      </div>
      <div class="info-row">
        <i class="bi bi-card-checklist"></i>
        <span>One attempt per session</span>
      </div>
      <div class="info-row">
        <i class="bi bi-trophy-fill"></i>
        <span>Score saved to your record</span>
      </div>
      <div class="info-row">
      ...
      <div style="margin-top:1.75rem;">
        ...
        <a href="userDashboard.jsp"
           style="display:block; text-align:center; margin-top:.9rem;
